...
bin/hipchat-hotline $TARGET_USER "This is a 'text' message"

# If your message contains tags, hipchat-hotline will presume you mean
# for it to be interpreted as html and send it that way.
bin/hipchat-hotline $TARGET_USER "This is an <b>html</b> message. <a href='https://hipchat.com'>HipChat Rules</a>"
...
bin/hipchat-hotline --message-format text $TARGET_USER "This is a 'text' message containing <b>html</b>."
...
# this with --notify:
bin/hipchat-hotline --notify false $TARGET_USER "This is a quiet message"
...
bin/hipchat-hotline "$TARGET_ROOM" "This is a 'text' message"

# If your message contains tags, hipchat-hotline will presume you mean
# for it to be interpreted as html and send it that way.
bin/hipchat-hotline "$TARGET_ROOM" "This is an <b>html</b> message. <a href='https://hipchat.com'>HipChat Rules</a>"

# But, if you want to override this html detection behavior, you can
# explicitly say that that your message should be sent as text:
bin/hipchat-hotline --message-format text "$TARGET_ROOM" "This is a 'text' message containing <b>html</b>."

# By default hipchat-hotline will attempt to notify (ie: buzz, blink,
# pop-up) everyone in the room that receives the message. However, you
# can control this with --notify:
bin/hipchat-hotline --notify false "$TARGET_ROOM" "This is a quiet message"
...
bin/hipchat-hotline --color red "$TARGET_ROOM" "This is a red message"
